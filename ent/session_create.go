...
func (_c *SessionCreate) SetRole(v session.Role) *SessionCreate {
...
func (_c *SessionCreate) SetFamilyID(id int) *SessionCreate {
...
func (_c *SessionCreate) SetNillableFamilyID(id *int) *SessionCreate {
	if id != nil {
...
func (_c *SessionCreate) SetFamily(v *Family) *SessionCreate {
