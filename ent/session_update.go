...
func (_u *SessionUpdate) SetRole(v session.Role) *SessionUpdate {
	_u.mutation.SetRole(v)
	return _u
}

// SetNillableRole sets the "role" field if the given value is not nil.
func (_u *SessionUpdate) SetNillableRole(v *session.Role) *SessionUpdate {
	if v != nil {
		_u.SetRole(*v)
	}
	return _u
...
func (_u *SessionUpdate) SetFamilyID(id int) *SessionUpdate {
...
func (_u *SessionUpdate) SetNillableFamilyID(id *int) *SessionUpdate {
	if id != nil {
...
func (_u *SessionUpdate) SetFamily(v *Family) *SessionUpdate {
...
func (_u *SessionUpdate) ClearFamily() *SessionUpdate {
...
func (_u *SessionUpdate) check() error {
	if v, ok := _u.mutation.Role(); ok {
		if err := session.RoleValidator(v); err != nil {
			return &ValidationError{Name: "role", err: fmt.Errorf(`ent: validator failed for field "Session.role": %w`, err)}
		}
	}
	return nil
}
...
func (_u *SessionUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.Role(); ok {
		_spec.SetField(session.FieldRole, field.TypeEnum, value)
	}
	...
	if _u.mutation.FamilyCleared() {
		edge := &sqlgraph.EdgeSpec{
			Rel:     sqlgraph.M2O,
			Inverse: true,
			Table:   session.FamilyTable,
			Columns: []string{session.FamilyColumn},
			Bidi:    false,
			Target: &sqlgraph.EdgeTarget{
...
// SetRole sets the "role" field.
func (_u *SessionUpdateOne) SetRole(v session.Role) *SessionUpdateOne {
	_u.mutation.SetRole(v)
	return _u
}

// SetNillableRole sets the "role" field if the given value is not nil.
func (_u *SessionUpdateOne) SetNillableRole(v *session.Role) *SessionUpdateOne {
	if v != nil {
		_u.SetRole(*v)
	}
	return _u
...
// SetFamilyID sets the "family" edge to the Family entity by ID.
func (_u *SessionUpdateOne) SetFamilyID(id int) *SessionUpdateOne {
	_u.mutation.SetFamilyID(id)
	return _u
}

// SetNillableFamilyID sets the "family" edge to the Family entity by ID if the given value is not nil.
func (_u *SessionUpdateOne) SetNillableFamilyID(id *int) *SessionUpdateOne {
	if id != nil {
		_u = _u.SetFamilyID(*id)
	}
	return _u
...
// SetFamily sets the "family" edge to the Family entity.
func (_u *SessionUpdateOne) SetFamily(v *Family) *SessionUpdateOne {
	return _u.SetFamilyID(v.ID)
}
...
// ClearFamily clears the "family" edge to the Family entity.
func (_u *SessionUpdateOne) ClearFamily() *SessionUpdateOne {
	_u.mutation.ClearFamily()
	return _u
}
